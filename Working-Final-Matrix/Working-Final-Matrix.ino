...
void checkButton(){
  ...
  digitalWrite(blockSound,HIGH);
  delay(30);
  digitalWrite(blockSound,LOW);
...
void loseGame(){
  ...
  matrix.fillScreen(matrix.Color333(0, 0, 0));
  digitalWrite(endSound, HIGH);
  delay(10);
  digitalWrite(endSound, LOW);
